...
public class AddProductServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String uploadPath="C:/Users/32466/eclipse-workspace/e-shop/src/main/webapp/eshopAdmin/productImages/"+imageFileName;
		...
		Product product=new Product(name,description,prix,stock,uploadPath);
		try {
